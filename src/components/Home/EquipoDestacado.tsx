    ...
    return (
        <section className="max-w-7xl mx-auto px-4">
            <div className="p-4 mx-auto flex justify-center">
                <div className='flex flex-col justify-center items-center bg-rojoPrimario-500 p-10 w-1/2'>
                    <h3 className='text-4xl text-center text-white uppercase font-bold pb-4'>Conexión <span className='text-azulPrimario-500'>Humana </span> Real</h3>
                    ...
                    <p className='text-2xl text-white font-bold text-center uppercase mt-4'>
                ...
                <div className='w-1/2 bg-rojoPrimario-500 flex justify-center items-center'>
